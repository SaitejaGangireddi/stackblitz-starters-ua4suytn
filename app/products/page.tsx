      ...
      <div className="max-w-7xl mx-auto px-6 -mt-16 relative z-20">
        <div className="grid md:grid-cols-3 gap-10">
          {categories.map((cat) => (
            <div
              key={cat.slug}
              className="group bg-white rounded-[3.5rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-stone-100 relative top-0 hover:-translate-y-2 flex flex-col"
            >
              {/* Image Section */}
              <div className="h-64 overflow-hidden relative">
                ...
                <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-md p-3 rounded-2xl shadow-lg">
                  <div style={{ color: COLORS.gold }} className="group-hover:scale-110 transition-transform">
                    {cat.icon}
                  </div>
                </div>
              </div>
              ...
              <div className="p-10 flex flex-col flex-1">
                ...
                <p className="text-stone-400 text-xs leading-relaxed italic mb-8 border-l-2 border-stone-100 pl-4 font-medium">
                  {cat.context}
                </p>
                ...
                <div className="mt-auto">
                  {cat.slug === 'paddy' ? (
                    ...
                    <div
                      className="flex items-center justify-between w-full px-8 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest bg-stone-100 text-stone-400 cursor-not-allowed"
                    >
                      Under Evaluation
                      <ChevronRight size={14} />
                    </div>
