...
import { Sprout, Award, History, Target, Users } from 'lucide-react';
  ...
  return (
    <div className="pb-24 bg-[#FBF9F6]">
      ...
      <div className="relative h-[450px] flex items-center justify-center overflow-hidden bg-stone-900">
        <img 
          src="https://images.unsplash.com/photo-1530507629858-e4977d30e9e0?q=80&w=2000" 
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <div className="flex items-center justify-center gap-4">
             ...
             <p className="text-white/90 font-black uppercase tracking-[0.4em] text-[10px]">A Farmer&apos;s Trust since 1996</p>
             <div className="h-[2px] w-12 bg-[#BF9B30]"></div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-[4rem] shadow-2xl overflow-hidden border border-stone-100 flex flex-col lg:flex-row items-stretch">
          ...
          <div className="lg:w-1/2 p-12 md:p-16 bg-stone-50 flex flex-col justify-center items-center text-center">
            <div className="relative group">
              <div style={{ borderColor: COLORS.gold }} className="absolute -inset-4 border-2 rounded-[3.5rem] opacity-20 group-hover:opacity-40 transition-opacity"></div>
              <img 
                src="https://res.cloudinary.com/dmkjnuolr/image/upload/v1776595754/IMG_2293.jpg_upqoz4.jpg" 
                className="relative rounded-[3rem] shadow-2xl object-cover h-[550px] w-full"
                alt="Our Founder's Vision"
              />
            </div>
            <p className="mt-10 text-stone-400 font-black uppercase tracking-[0.3em] text-[10px]">Rooted in Telangana</p>
          </div>
          ...
          <div className="flex-1 p-12 md:p-20 flex flex-col justify-center">
            <div className="flex items-center gap-3 mb-8">
               ...
               <span style={{ color: COLORS.gold }} className="font-black uppercase tracking-widest text-xs">Our Founding Legacy</span>
            </div>
            
            <h2 style={{ color: COLORS.green }} className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-[0.9] mb-10">
              Built by Farmers, <br />
            ...
            <div className="space-y-8 text-stone-600 text-lg leading-relaxed font-medium">
              <p>
                Annapurna Seeds &amp; Farms was founded in <strong>1996 by Mr. Chandupatla Venugopal Reddy</strong>, coming from a farming family in Telangana.
              </p>
              <p>
                Having witnessed firsthand the challenges that farmers face, our company recognized that the <strong>purity of seeds</strong> was one of the most critical concerns in agriculture. 
              </p>
              ...
              <div className="p-10 bg-[#FBF9F6] rounded-[3rem] border-l-[12px] border-[#2B5A27] shadow-inner relative overflow-hidden">
                ...
                <p style={{ color: COLORS.green }} className="font-black italic text-2xl uppercase tracking-tight">
                  &ldquo;Purity is our mantra.&rdquo;
                </p>
                <p className="mt-4 text-base opacity-70 leading-relaxed">
                  To this day, we uphold these values, ensuring that every seed we produce carries the legacy of trust, quality, and excellence that has defined us from the very beginning.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-24 px-6">
         <div className="text-center mb-16">
            <h3 style={{ color: COLORS.green }} className="text-3xl font-black uppercase tracking-tighter">Our Core <span style={{ color: COLORS.gold }}>Objectives</span></h3>
         </div>
...
function AboutValueCard({ icon, title, desc }: any) {
  return (
    <div className="bg-white p-12 rounded-[3.5rem] shadow-sm border border-stone-100 hover:shadow-2xl transition-all duration-500 text-center group">
      <div style={{ color: COLORS.gold }} className="mb-6 flex justify-center group-hover:scale-110 transition-transform">
        {icon}
      </div>
      <h4 style={{ color: COLORS.green }} className="text-xl font-black uppercase tracking-tighter mb-3">{title}</h4>
      <p className="text-stone-400 text-sm font-bold leading-relaxed uppercase tracking-widest italic opacity-70">{desc}</p>
    </div>
  );
}